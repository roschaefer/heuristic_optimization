...
\begin{homeworkProblem}[Approach]
...
\begin{homeworkProblem}[Findings]
We started off by just implementing the cost function in a python script.
...
For this reason it's necessary to start with a user-defined initial configuration that fullfills both constrains and then modify this configuration step by step.
